...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <livewire:single-product.breadcrumb-section />
        <livewire:single-product.single-product />
        <livewire:single-product.more-product />
        <livewire:single-product.logo-carousel />
